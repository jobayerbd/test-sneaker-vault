  ...
  return (
    <div className="max-w-4xl mx-auto py-24 px-4 animate-in fade-in zoom-in-95 duration-700">
      ...
      <div className="text-center mt-16">
        <button onClick={() => onNavigate('shop')} className="bg-black text-white px-12 py-5 rounded-2xl font-black uppercase tracking-[0.3em] text-[10px] shadow-2xl hover:bg-red-700 transition-all transform active:scale-95">Continue Exploration</button>
      </div>
    </div>
  );
};
